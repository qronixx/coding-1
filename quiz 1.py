...
value = input('give me a decimal to be multiplie by 2')
print(2 * float(value))
...
# Functions are important because it's how we prgram. Another reason it is important is because that's how we get our progamming/coding to show.
